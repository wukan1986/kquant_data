...
"""
        ...
        https://github.com/rainx/pytdx/blob/master/pytdx/reader/gbbq_reader.py
        https://github.com/rainx/pytdx/blob/master/pytdx/parser/get_xdxr_info.py
"""
...
class GbbqReader(object):
    ...
    def get_df(self, fname):
        ...
        df = pd.DataFrame(data=result, columns=['market', 'code', 'datetime', 'category',
                                                'hongli_panqianliutong',  # 红利，每10股派几元，
                                                'peigujia_qianzongguben',  # 配股价
                                                'songgu_qianzongguben',  # 送股，每10股送几股
                                                'peigu_houzongguben'])  # 配股，每10股配几股
        return df
...
if __name__ == '__main__':
    result = GbbqReader().get_df(r"D:\sh\gbbq")
    result.to_csv(r'd:\gbbq.csv')
    print(result)
